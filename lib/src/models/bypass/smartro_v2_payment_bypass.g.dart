...
SmartroV2PaymentBypass _$SmartroV2PaymentBypassFromJson(Map<String, dynamic> json) => $checkedCreate(
      ...
      fieldKeyMap: const {'goodsCnt': 'GoodsCnt', 'skinColor': 'SkinColor', 'openType': 'OpenType'},
    );

Map<String, dynamic> _$SmartroV2PaymentBypassToJson(SmartroV2PaymentBypass instance) => <String, dynamic>{
      if (instance.goodsCnt case final value?) 'GoodsCnt': value,
