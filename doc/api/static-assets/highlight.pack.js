  ...
  var e = (() => {
    ...
    return (e) => {
      const d = { match: /\s+/, relevance: 0 },
        ...
        E = { match: [/\./, a(...i, ...c)], className: { 2: "keyword" } },
        k = { match: t(/\./, a(...u)), relevance: 0 },
        C = u.filter((e) => "string" == typeof e).concat(["_|0"]),
        N = {
          variants: [
            {
              className: "keyword",
      ...
      const X = {
        ...
        Q = {
          ...
          contains: [
            {
              begin: a(n(t(f, /\s*:/)), n(t(f, /\s+/, f, /\s*:/))),
              end: /:/,
              relevance: 0,
              contains: [
                { className: "keyword", match: /\b_\b/ },
                { className: "params", match: f },
              ],
            },
            ...A,
            ...B,
        ...
        Y = {
          match: [/(func|macro)/, /\s+/, a(V.match, f, F)],
          className: { 1: "keyword", 3: "title.function" },
          contains: [J, Q, d],
          illegal: [/\[/, /%/],
        },
        ...
        ae = {
          ...
          contains: [
            ...
            ...B,
            {
              ...
              keywords: S,
              contains: [{ scope: "title.class.inherited", match: y }, ...B],
              relevance: 0,
            },
          ],
        };
