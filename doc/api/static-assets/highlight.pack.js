    ...
    return (
      ...
      (function t(s, r) {
        ...
        return (
          ...
          (l = l || /\w+/),
          s.keywords && (s.keywords = U(s.keywords, e.case_insensitive)),
          ...
          r &&
            ...
            s.endsWithParent &&
              r.terminatorEnd &&
              (o.terminatorEnd += (s.end ? "|" : "") + r.terminatorEnd)),
  ...
  const J = t,
    ...
    ne = (t) => {
      ...
      function _(e, t, i, s) {
        ...
        function c() {
          if (!O.keywords) return void A.addText(M);
          let e = 0;
        ...
        function b(e, n) {
          return (
            e.scope &&
              ...
              A.openNode(w.classNameAliases[e.scope] || e.scope),
            e.beginScope &&
              (e.beginScope._wrap
                ? (g(
                    M,
                  ...
                  (M = ""))
                : e.beginScope._multi && (u(e.beginScope, n), (M = ""))),
            (O = Object.create(e, {
              parent: {
                value: O,
              },
        ...
        function h(e) {
          return 0 === O.matcher.regexIndex ? ((M += e[0]), 1) : ((D = !0), 0);
        }
        function f(e) {
          const n = e[0],
        ...
        function y(a, s) {
          ...
          if (
            ...
            if (((M += t.slice(s.index, s.index + 1)), !r)) {
          ...
          if (((N = s), "begin" === s.type))
            return ((e) => {
              const t = e[0],
                a = e.rule,
                i = new n(a),
                s = [a.__beforeBegin, a["on:begin"]];
              for (const n of s)
                if (n && (n(e, i), i.isMatchIgnored)) return h(t);
              return (
                a.skip
                  ? (M += t)
                  : (a.excludeBegin && (M += t),
      ...
      function N(e) {
        ...
        const t = ((e) => {
          ...
          return n.split(/\s+/).find((e) => h(e) || v(e));
        })(e);
        if (h(t)) return;
        if (
      ...
      function w() {
        "loading" !== document.readyState
          ? document.querySelectorAll(p.cssSelector).forEach(N)
          : (y = !0);
      }
      function v(e) {
  ...
  var Ue = Object.freeze({
    ...
    grmr_c: (e) => {
      const n = e.regex,
        ...
        b = [c, r, t, e.C_BLOCK_COMMENT_MODE, l, o],
        m = {
          variants: [
            { begin: /=/, end: /;/ },
            {
            ...
            { relevance: 0, match: /,/ },
            {
              ...
              contains: [
                ...
                r,
                {
                  ...
                  keywords: u,
                  relevance: 0,
                  contains: ["self", t, e.C_BLOCK_COMMENT_MODE, o, l, r],
                },
              ],
            },
            r,
    ...
    grmr_javascript: (e) => {
      const n = e.regex,
        ...
        a = {
          ...
          isTrulyOpeningTag: (e, n) => {
            ...
            ((i = s.match(/^\s*=/)) ||
              ((i = s.match(/^\s+extends\s+/)) && 0 === i.index)) &&
              n.ignoreMatch();
          },
        },
        i = {
      ...
      const h = [].concat(m, c.contains),
        f = h.concat([
          { begin: /\(/, end: /\)/, keywords: i, contains: ["self"].concat(h) },
        ]),
        _ = {
          className: "params",
          begin: /\(/,
    ...
    grmr_swift: (e) => {
      const n = { match: /\s+/, relevance: 0 },
        ...
        g = [
          ...
          { className: "built_in", match: b(/\b/, m(...Ce), /(?=\()/) },
        ],
        u = { match: /->/, relevance: 0 },
        p = [
          u,
        ...
        S = [
          ...
          { className: "keyword", match: b(/@/, m(...Fe)) },
          {
            className: "meta",
            match: b(/@/, Le),
          },
      ...
      const C = {
        ...
        R = {
          ...
          contains: [
            {
              begin: m(d(b(Le, /\s*:/)), d(b(Le, /\s+/, Le, /\s*:/))),
              end: /:/,
              relevance: 0,
              contains: [
